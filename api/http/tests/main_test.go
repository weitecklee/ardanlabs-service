...
import (
	...
	authbuild "github.com/weitecklee/ardanlabs-service/api/cmd/services/auth/build/all"
	salesbuild "github.com/weitecklee/ardanlabs-service/api/cmd/services/sales/build/all"
	"github.com/weitecklee/ardanlabs-service/api/http/api/apitest"
	"github.com/weitecklee/ardanlabs-service/api/http/api/mux"
	"github.com/weitecklee/ardanlabs-service/app/api/auth"
	"github.com/weitecklee/ardanlabs-service/app/api/authclient"
	"github.com/weitecklee/ardanlabs-service/business/api/dbtest"
	"github.com/weitecklee/ardanlabs-service/foundation/docker"
)
